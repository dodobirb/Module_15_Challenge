...
def recommend_portfolio(intent_request):
        ...
        if age is not None:
            ...
            if age < 0:
                return build_validation_result(
                    False,
                    "age",
                    "You must provide a valid age to use this service, "
                    "please provide your actual age.",
                )
            elif age > 65:
                return build_validation_result(
                    False,
                    "age",
                    "This service is for users who have yet to reach "
                    "retirement age. Please view our services for clients "
                    "who are in their retirement years." ,
                )
    ...
    if risk_level == "None":
        return build_validation_result(
            True,
            "We recommend a portfolio structure of 100% bonds (AGG), 0% equities (SPY)."
        )
        
    elif risk_level == "Low":
        return build_validation_result(
            True,
            "We recommend a portfolio structure of 60% bonds (AGG), 40% equities (SPY)."
        )
        
    elif risk_level == "Medium":
        return build_validation_result(
            True,
            "We recommend a portfolio structure of 40% bonds (AGG), 60% equities (SPY)."
        )
        
    elif risk_level == "High":
        return build_validation_result(
            True,
            "We recommend a portfolio structure of 20% bonds (AGG), 80% equities (SPY)."
        )
        ...
        return build_validation_result(
            False,
            "riskLevel",
            "The risk level you entered is not one of the options provided. "
            "Please indicate your risk level in the same manner spelled out "
